...
const OurEvent = () => {
  return (
    <div className="max-w-7xl mx-auto ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3  gap-y-24 gap-x-5 p-4">
        {eventData.map((item, index) => (
          <div key={index} className="relative">
            ...
            <div className="absolute left-1/2 -translate-x-1/2 translate-y-1/3 -bottom-3 w-[80%] transition-all duration-300">
              <div
                className="
        bg-[#F5F7FA] shadow-md rounded-xl py-6 px-4 text-center cursor-pointer overflow-hidden transition-all duration-300 group"
              >
                ...
                <div className="max-h-0 overflow-hidden group-hover:max-h-40 group-hover:mt-5 transition-all duration-300">
